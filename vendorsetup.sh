...
git clone --depth=1 https://github.com/manidweep/device_oneplus_sm8250-common.git -b aosp device/oneplus/sm8250-common
...
# Common Vendor Tree
git clone --depth=1 https://github.com/manidweep/vendor_oneplus_sm8250-common.git -b aosp vendor/oneplus/sm8250-common

echo 'Cloning Kernel tree [4/6]'
# Kernel Tree
rm -rf kernel/oneplus
git clone --depth=1 https://github.com/YumeMichi/kernel_oneplus_sm8250.git kernel/oneplus/sm8250

echo 'Cloning Hardware Oplus [5/6]'
# Hardware Oplus
rm -rf hardware/oplus
git clone --depth=1 https://github.com/manidweep/hardware-oplus.git -b aosp hardware/oplus
